  ...
  return (
    <div className="relative overflow-hidden rounded-2xl max-w-4xl mx-auto">
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2">
        <div className="bg-background/80 backdrop-blur-xl border rounded-full px-4 py-2 flex items-center gap-1">
          {/* Background Selection */}
          <ControlPopover
            toolkitTitle="Background Selection"
              ...
              <ScrollArea className="h-[400px] w-full rounded-md">
                <div className="grid grid-cols-3 gap-2 p-2">
                  {backgrounds.map((bg, index) => (
                    <div
                      key={index}
                      className={`h-16 rounded-md cursor-pointer transition-all hover:scale-105 relative ${
                        selectedBg === bg
          ...
          {/* Rotate button */}
        <ToolButton tooltip="Rotate Image" onClick={handleRotate}>
            <RotateCw />
          </ToolButton>
          ...
          {/* Undo/Redo buttons */}
          <ToolButton tooltip="undo" onClick={undo} disabled={!canUndo}>
            <Undo2 />
          </ToolButton>
          <ToolButton tooltip="redo" onClick={redo} disabled={!canRedo}>
            <Redo2 />
          </ToolButton>
          ...
          {/* Reset button */}
          <ToolButton tooltip="reset" onClick={handleReset}>
            <RotateCcw />
          </ToolButton>

          <ToolButton tooltip="Code">
            <Code2 />
          </ToolButton>
          <ToolButton >
            <Wrench />
          ...
          {/* Export Options */}
          <ControlPopover title="Export Options" toolkitTitle="Export">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Export Options</h3>
              <div className="space-y-6 rounded-xl shadow-lg">
                {/* PNG Format Section */}
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left font-medium text-primary bg-primary-foreground rounded-lg hover:bg-primary-foreground/50 "
                  >
                    Maximum Quality PNG
                  </button>
                </div>
