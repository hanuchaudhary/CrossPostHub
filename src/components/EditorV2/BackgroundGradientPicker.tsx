...
export const BackgroundGradientPicker = ({ canvas }: BackgroundGradientPickerProps) => {
      ...
      <PopoverContent className="w-[300px] bg-[#1A1F2C] border-gray-800">
        <div className="space-y-4">
            ...
            {GRADIENTS.map((gradient, index) => (
              <button
                ...
                style={{
                  ...
                  border: gradient.value === "transparent" ? "1px dashed #666" : "none"
                }}
          ...
          <Button 
            ...
            onClick={() => applyGradient("transparent")}
          >
            Show More
          </Button>
        </div>
